...
htmlhelp_basename = 'MeerkatANALYSISdoc'
...
latex_documents = [
    (master_doc, 'MeerkatANALYSIS.tex', 'Meerkat ANALYSIS Documentation',
...
man_pages = [
    (master_doc, 'meerkatanalysis', 'Meerkat ANALYSIS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MeerkatANALYSIS', 'Meerkat ANALYSIS Documentation',
     author, 'MeerkatANALYSIS', 'One line description of project.',
     'Miscellaneous'),
]
